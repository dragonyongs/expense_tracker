        ...
        <div className='relative flex items-center w-full h-full px-8'>
            <div className='w-full'>
                <div className='mb-20'>
                    ...
                    <h1 className='mb-7 text-3xl tracking-tight dark:text-white'>
                        안녕하세요.<br />
                        <span className='font-bold dark:font-semibold'>Expense Tracker</span> 입니다.
                    </h1>
