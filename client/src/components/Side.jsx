    ...
    return (
        <div className='max-w-sm max-h-[600px]'>
            <div className="mb-4 font-bold text-4xl">
                ...
                <h2 className="text-blue-500 dark:text-blue-600">서비스 이용 안내</h2>
            </div>
            <p className="dark:text-slate-500">
                웹앱 개발 단계에서 사이트 이용에 관한 일부 안내사항을 전달합니다.
            </p>
            <ul className="mt-12">
                <li className="flex items-center space-x-6">
                    <div className="flex justify-center items-center w-24 h-24 rounded-full bg-white shadow-sm dark:bg-slate-800">
                        <FcSynchronize className="w-12 h-12" />
                    </div>
                    <div className="dark:text-slate-500 w-72">
                        <h5 className="font-semibold text-lg">비활성화 상태</h5>
                        <h4>새로고침 및 앱종료 후 <span className="text-indigo-500 dark:text-indigo-600">약 50초 후</span> 재접속하면 정상적으로 이용이 가능</h4>
                    </div>
                </li>
                <li className="flex items-center space-x-6 mt-4">
                    <div className="flex justify-center items-center w-24 h-24 rounded-full bg-white shadow-sm dark:bg-slate-800">
                        <FcTabletAndroid className="w-12 h-12" />
                    </div>
                    <div className="dark:text-slate-500 w-72">
        ...
        //                         <h5>밥은 먹었어요?</h5>
        //                         <h4 className="font-semibold text-lg">임직원 <span className="text-indigo-500 dark:text-indigo-600">월 10만원 지원!</span></h4>
        //                     </div>
        //                 </li>
        ...
        //                     <div className="dark:text-slate-500">
        //                         <h5>여비교통비 지원</h5>
        //                         <h4 className="font-semibold text-lg">행사 참여 교통비 <span className="text-indigo-500 dark:text-indigo-600">별도 입금!</span></h4>
        //                     </div>
        //                 </li>
        //             </ul>
        //         </div>
