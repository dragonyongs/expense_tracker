            ...
            <div className='space-y-6 h-dateFilter-screen overflow-y-auto'>
                ...
                <div className="space-y-4">
                    <div className='flex justify-between items-center'>
                        <label className="text-sm font-medium text-gray-700">결재 라인</label>
                        <button 
                    ...
                    {showPopover && (
                        <div className='p-4 bg-white shadow-lg rounded-lg border border-gray-200'>
                            ...
                            <div className="flex justify-end mt-3">
                                ...
                                <div
                                    className="space-y-2 p-4 rounded-lg bg-gray-50"
                                >
                                        ...
                                        >
                                            <div className="flex items-center justify-between p-3">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <span className="flex items-center justify-center bg-blue-100 text-blue-800 rounded-full w-8 h-8 font-medium">
                                                        {index + 1}
                                                    </span>
