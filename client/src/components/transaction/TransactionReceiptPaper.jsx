      ...
      <>
        ...
        <div className="flex items-center justify-between p-2 border-b dark:border-b-gray-700">
          ...
          <div className="flex items-center">
            <button className="p-2 hover:bg-gray-100 rounded-full dark:text-gray-200">
        ...
        <div
          ref={ref}
          className="max-w-lg mx-auto shadow-xl dark:bg-slate-900 relative border border-gray-100 dark:border-transparent dark:text-gray-300"
        >
          ...
          <div className="p-6 font-mono text-sm">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-sm">지출(팀카드)</p>
            </div>

            {/* Store Info */}
            <div className="mt-4 text-sm space-y-1">
              <p>카드번호: {cardNumber}</p>
              <p>카드소유: {`${cardUser.member_name} ${cardUser.position}`}</p>
              <p>
                거래일자:{" "}
                {formatDateToKorean(transaction.transaction_date, "monthDay")}
              </p>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <div className="flex space-x-4">
                  <span>1</span>
                  <span>{transaction.transaction_amount.toLocaleString()}</span>
                </div>
              </div>
            </div>
            ...
            <div className="text-sm">
              <div className="flex justify-between">
                ...
                <span className="tracking-tighter">
                  {formatDateToKorean(transaction.createdAt, "fullWithTime")}
                </span>
              </div>
            </div>
          </div>
